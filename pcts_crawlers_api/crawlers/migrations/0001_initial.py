# Generated by Django 3.2.8 on 2021-11-02 20:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_name_display', models.CharField(max_length=100, unique=True, verbose_name='Site Name Display')),
                ('url_root', models.CharField(max_length=1024, unique=True, verbose_name='Root Url')),
                ('task_name', models.CharField(max_length=50, unique=True, verbose_name='Task Name Prefix')),
                ('task_enabled', models.BooleanField(default=True, verbose_name='Periodic Task Enabled')),
                ('task_one_off', models.BooleanField(default=False, verbose_name='Task  One-off (Disable after execution)')),
                ...
                ('contains_end_path_keyword', models.BooleanField(default=False, verbose_name='Contains End Path with Keyword for Search')),
                ...
                ('cron_minute', models.CharField(default='0', max_length=20, verbose_name='Crontab Minute')),
                ('cron_hour', models.CharField(default='4', max_length=20, verbose_name='Crontab Hour')),
                ...
                ('contains_dynamic_js_load', models.BooleanField(default=True, verbose_name='Contains Dynamic JS Loading')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('PENDING', 'PENDING'), ('RECEIVED', 'RECEIVED'), ('STARTED', 'STARTED'), ('SUCCESS', 'SUCCESS'), ('FAILURE', 'FAILURE'), ('REVOKED', 'REVOKED'), ('REJECTED', 'REJECTED'), ('RETRY', 'RETRY'), ('IGNORED', 'IGNORED')], default='STARTED', max_length=50, verbose_name='Execution State')),
